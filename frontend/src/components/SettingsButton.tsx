...
// import SettingsPopover from './modals/SettingsModal';
...
//       {/* Settings Icon */}
//       <div
//         className={`cursor-pointer p-1 rounded-md text-gray-600`}
//         onClick={() => setShowingTrainingSettings(!showTrainingSettings)}
//       >
//         <Settings size={30} />
//       </div>
//     </div>
