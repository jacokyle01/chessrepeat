...
export const whiteKingI = () => {
  return h('svg', { attrs: { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 45 45' } }, [
    h(
      ...
      [
        h('path', { attrs: { 'stroke-linejoin': 'miter', d: 'M22.5 11.63V6M20 8h5' } }),
        h('path', {
          attrs: {
            fill: '#fff',
            'stroke-linecap': 'butt',
        ...
        h('path', {
          attrs: { d: 'M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0' },
        }),
      ],
    ),
  ]);
